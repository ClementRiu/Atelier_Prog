...
public:
    ...
    void tourGestion(CarteduMonde &carte, Bouton boutonFinTour, Bouton boutonSauvegarde, Bouton boutonAction,
                     Bouton boutonInventaire, bool &save, std::vector<Unite*> unite1, std::vector<Unite*> unite2);
    void finTourGestion();
