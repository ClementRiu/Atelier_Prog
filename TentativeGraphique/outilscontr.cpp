...
Imagine::Coords<2> translate(int positiondepx, int positiondepy, int pos_centrex, int pos_centrey) {
    Imagine::Coords<2> posdep;
    posdep[0] = positiondepx - widthworld - 2 - widthmmap / 2;
    posdep[1] = positiondepy - 2 - heightmmap / 2;
    posdep = posdep / taille_case_mmap;
    posdep[0] = pos_centrex + posdep[0];
    posdep[1] = pos_centrey + posdep[1];
    return posdep;
}
