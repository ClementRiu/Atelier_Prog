...
protected:
    ...
    Imagine::Image<Imagine::Color> frame;   //Image de l'unité.
public:
    Unite();
    ...
    //Affiche l'unité à sa place.
    void affiche_unite(Imagine::Coords<2> pos_centre);
    ...
    void deplaceVersCase(Case &c2, Case &c1, CarteduMonde carte);

    // ATTENTION, cette fonction peut rencontrer des problemes lorsque l'on modifie la fonction boutonAction
    void tourCombat(CarteduMonde &carte, Bouton boutonFinTour, Bouton boutonAction, std::vector<Unite*> unite1, std::vector<Unite*> unite2);
...
public:
    ...
    virtual void declencheCombat(Unite* u, std::vector<Unite*> unite1, std::vector<Unite*> unite2);
