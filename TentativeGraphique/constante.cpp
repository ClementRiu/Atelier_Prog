...
Imagine::Image<Imagine::Color> sbire1;
Imagine::Image<Imagine::Color> sbire2;
...
bool charge_image() {
    ...
    if (!Imagine::load(sbire1, srcPath("/Image/Icone/unite1.jpg"))) {
        std::cout << "Image \"unite1.jpg\" non trouvée." << std::endl;
        return false;
    }
    if (!Imagine::load(sbire2, srcPath("/Image/Icone/unite2.jpg"))) {
        std::cout << "Image \"unite2.jpg\" non trouvée." << std::endl;
        return false;
    }
